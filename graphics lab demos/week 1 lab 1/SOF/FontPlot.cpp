...
void SOF::FontPlot::DrawChar(float x, float y, char c, glm::vec4 color)
{
	//bind the shaders
	shader->Use();
...
void SOF::FontPlot::DrawString(float x, float y, const std::string &text, glm::vec4 color, SOF::FontPlot::SOF_JUSTIFY just)
{
	int stringWidth = 0;
