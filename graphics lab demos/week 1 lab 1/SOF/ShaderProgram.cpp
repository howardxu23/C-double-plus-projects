...
void SOF::ShaderProgram::AssignTextureSampler(std::string uniform, SOF::Texture *t)
{
	AssignTextureSampler(uniform, t, 0);
}

void SOF::ShaderProgram::AssignTextureSampler(std::string uniform, SOF::Texture *t, int num)
{
	...
	glBindTexture(GL_TEXTURE_2D, t->GetObject(num));
}