...
namespace SOF
{
	...
	public:
		...
		void DrawChar(float x, float y, char c, glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f) );
		void DrawString(float x, float y, const std::string &string, glm::vec4 color = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), SOF_JUSTIFY just = SOF_JUSTIFY_LEFT);
	};
}