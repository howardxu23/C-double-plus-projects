...
namespace SOF
{
	...
	public:
		...
		virtual void Init() = 0;
		virtual void Draw() = 0;
		virtual void KeyCallback(GLFWwindow*, int, int, int, int) {} // general keyboard response
		virtual void MouseButtonCallback(GLFWwindow*, int, int, int) {} // general mouse response
