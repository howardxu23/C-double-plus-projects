...
glm::vec2 SOF::App::GetMousePos() // return current mouse position in pixels
{
	return parent->GetMousePos();
}

glm::vec2 SOF::App::GetMousePosNormalized() // return current mouse position in normalized (0-1) coordinates
{
	return parent->GetMousePosNormalized();
}
